...
define('COLLAGE_FRAME', realpath(__DIR__ . DIRECTORY_SEPARATOR . '..' . $config['collage']['frame']));
define('COLLAGE_BACKGROUND', empty($config['collage']['background']) ? '' : realpath(__DIR__ . DIRECTORY_SEPARATOR . '..' . $config['collage']['background']));
...
define('COLLAGE_PLACEHOLDER_PATH', realpath(__DIR__ . DIRECTORY_SEPARATOR . '..' . $config['collage']['placeholderpath']));
