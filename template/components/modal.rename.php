    ...
    <div class="modal-inner">
        <form id="set-image-name" class="form">
            <div class="modal-body">
                ...
                <p>This image will be used for the Website and Intranet</p>
            ...
            <div class="modal-buttonbar">
                <button class="modal-button rotaryfocus" data-severity="primary" id="set-image-name-submit" type="submit">
