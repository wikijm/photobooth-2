...
// I C O N S
$config['icons']['admin_back'] = 'material-icons mi-arrow-back';
$config['icons']['admin_back_short'] = 'material-icons mi-arrow-back-ios-new';
$config['icons']['admin_menutoggle'] = 'material-icons mi-menu-open';
$config['icons']['admin_save'] = 'material-icons mi-save';
$config['icons']['admin_save_success'] = 'material-icons mi-check';
$config['icons']['admin_save_error'] = 'material-icons mi-error-outline';
$config['icons']['admin_signout'] = 'material-icons mi-logout';
$config['icons']['admin'] = 'material-icons mi-admin-panel-settings';
$config['icons']['home'] = 'material-icons mi-home';
$config['icons']['gallery'] = 'material-icons mi-photo-library';
$config['icons']['dependencies'] = 'material-icons mi-checklist';
$config['icons']['update'] = 'material-icons mi-system-update-alt';
$config['icons']['slideshow'] = 'material-icons mi-slideshow';
$config['icons']['livechroma'] = 'material-icons mi-auto-fix-high';
$config['icons']['faq'] = 'material-icons mi-not-listed-location';
$config['icons']['manual'] = 'material-icons mi-info';
$config['icons']['telegram'] = 'material-icons mi-chat';
$config['icons']['cups'] = 'material-icons mi-print';
$config['icons']['take_picture'] = 'material-icons mi-camera';
$config['icons']['take_collage'] = 'material-icons mi-groups';
$config['icons']['close'] = 'material-icons mi-close';
$config['icons']['refresh'] = 'material-icons mi-refresh';
$config['icons']['delete'] = 'material-icons mi-delete-forever';
$config['icons']['print'] = 'material-icons mi-print';
$config['icons']['save'] = 'material-icons mi-save';
$config['icons']['download'] = 'material-icons mi-cloud-download';
$config['icons']['qr'] = 'material-icons mi-qr-code';
$config['icons']['mail'] = 'material-icons mi-email';
$config['icons']['mail_close'] = 'material-icons mi-close';
$config['icons']['mail_submit'] = 'material-icons mi-mark-email-read';
$config['icons']['filter'] = 'material-icons mi-photo-filter';
$config['icons']['chroma'] = 'material-icons mi-auto-fix-high';
$config['icons']['fullscreen'] = 'material-icons mi-fullscreen';
$config['icons']['share'] = 'material-icons mi-share';
$config['icons']['zoom'] = 'material-icons mi-zoom-in';
$config['icons']['logout'] = 'material-icons mi-logout';
$config['icons']['date'] = 'material-icons mi-access-time';
$config['icons']['spinner'] = 'material-icons mi-change-circle fa-spin';
$config['icons']['update_git'] = 'material-icons mi-system-update-alt';
$config['icons']['password_visibility'] = 'material-icons mi-visibility';
$config['icons']['password_toggle'] = 'mi-visibility mi-visibility-off';
$config['icons']['slideshow_play'] = 'material-icons mi-play-circle-outline';
$config['icons']['slideshow_toggle'] = 'mi-play-circle-outline mi-pause-circle-outline';
