<?php
include('template/components/helper/index.php');
session_start();
$fileRoot = '';
...
<div id="wrapper">
    ...
    <?php 
        ...
        include('template/components/'. $templateFolder .'start.loader.php');
        include('template/components/'. $templateFolder .'start.results.php'); 
...
<?php
    include($fileRoot . 'template/components/evolution/modal.qr.php');
...
<script type="text/javascript" src="<?=$fileRoot?>resources/js/evolution/qrcode.js?v=<?php echo $config['photobooth']['version']; ?>"></script>
